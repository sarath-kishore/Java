...
public class ParkingLotService {
    ...
    public ResponseEntity<String> markUnavailable(List<UpdateSpotDetails> unavailableSpots) {
// check if db is initialised first. throw exception
        ...
        for(UpdateSpotDetails spotDetails : unavailableSpots){
            ...
            if (spot != null) {
                ...
                throw new RuntimeException("Parking spot not found for the given floorId and spotId");
            }
        }
    ...
    public ResponseEntity<String> reserveSpot(CustomerDetails customer) {
        ParkingSpot spot = parkingSpotRepository.findOpenSpot();
        if(spot==null)
            return ResponseEntity.ok("Spot could not be reserved.");
    ...
    public ResponseEntity<String> vacateSpot(UpdateSpotDetails spotDetails) {
        ParkingSpot spot = parkingSpotRepository.findByFloorIdAndSpotId(spotDetails.getFloorId(), spotDetails.getSpotId());
